...
# from geatpy.moeas4NN.data.objects.list import DATASETS, get_dataset_names
# from geatpy.moeas4NN.data.objects.ProcessedData import ProcessedData
from sklearn.model_selection import train_test_split
from sklearn.preprocessing import StandardScaler, LabelEncoder
from geatpy.moeas4NN.detect_groups import detect_allgroups, detect_groups
